...
class PrinterPaperSheetType extends Model
{
    use SoftDeletes;
    ...
    protected $table = 'bm_printer_paper_sheet_types';
    ...
    public static $showRules = [
        'printerPaperSheetType' => 'required|exists:App\Models\Bm\PrinterPaperSheetType,id,deleted_at,NULL',
    ];
